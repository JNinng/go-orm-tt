...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.OwnerUserID = field.NewInt64(tableName, "owner_user_id")
	_sysUser.OwnerDeptID = field.NewInt64(tableName, "owner_dept_id")
	_sysUser.OwnerUserGroupID = field.NewInt64(tableName, "owner_user_group_id")
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.OwnerDeptID = field.NewInt64(table, "owner_dept_id")
	s.OwnerUserGroupID = field.NewInt64(table, "owner_user_group_id")
...
func (s *sysUser) fillFieldMap() {
	...
	s.fieldMap["owner_dept_id"] = s.OwnerDeptID
	s.fieldMap["owner_user_group_id"] = s.OwnerUserGroupID
