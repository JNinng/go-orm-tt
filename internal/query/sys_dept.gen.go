...
func newSysDept(db *gorm.DB, opts ...gen.DOOption) sysDept {
	...
	_sysDept.OwnerUserID = field.NewInt64(tableName, "owner_user_id")
	_sysDept.OwnerUserGroupID = field.NewInt64(tableName, "owner_user_group_id")
...
type sysDept struct {
	...
	ALL              field.Asterisk
	ID               field.Int64  // 部门 ID
	Status           field.Int16  // 数据状态，0：禁用、1：启用
	CreatedBy        field.Int64  // 创建人
	CreatedAt        field.Time   // 创建时间
	UpdatedBy        field.Int64  // 更新人
	UpdatedAt        field.Time   // 更新人
	DeletedAt        field.Field  // 删除时间
	TenantID         field.String // 租户 ID
	ParentID         field.Int64  // 父级部门 ID
	Name             field.String // 部门名
	OwnerUserID      field.Int64  // 部门管理员用户
